  ...
  return (
    <div className="min-h-screen bg-green-50 flex items-center justify-center px-4">
      <div className="w-full max-w-xs">
        ...
        <form onSubmit={submit} className="bg-white rounded-2xl border border-green-100 shadow-sm p-6 space-y-4">
          <div>
          ...
          <button
            type="submit"
            className="w-full bg-green-900 text-white text-sm font-semibold py-2 rounded-lg hover:bg-green-700 transition-colors"
          >
            Unlock
          </button>
        </form>
