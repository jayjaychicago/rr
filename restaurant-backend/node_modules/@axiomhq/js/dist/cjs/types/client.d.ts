...
declare class BaseClient extends HTTPClient {
     ...
     *
     */
    ingestRaw: (dataset: string, data: string | Buffer | Uint8Array | ReadableStream, contentType?: ContentType, contentEncoding?: ContentEncoding, options?: IngestOptions) => Promise<IngestStatus>;
    protected encodeIngestPayload: (data: string | Buffer | Uint8Array | ReadableStream, contentEncoding: ContentEncoding) => Promise<{
